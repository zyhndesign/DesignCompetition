	...
	<div class="zyTwoSide zyMargin60" id="zyInfoPanel">
		<div class="zyCLeft zyTipPanel">
			...
			<div id="zyStep2Tip" class="zyStepTip zyHidden">
				...
				<p class="zyText">
					1. 提交3张产品实物照片，单张图片大小<font class="zyFF0000">不得超过2M</font>。<br>
					<br> 2. 填写产品/服务设计说明（300字以内），并提交 相应的辅助资料（如产品/服务网页链接）。<br>
					<br> 3. 缩略图必须为<font class="zyFF0000">正方形</font>，500-600px，
					图片大小<font class="zyFF0000">不得超过1M</font>。<br>
					<br> 4. 附件采用压缩包（zip）形式，里面包含三张<font class="zyFF0000">350dpi及以上的产品实物照片，明书扫描文档</font>等信息。<br>
					<br> 另外，为保证本次大赛评选的公正性，参赛作品及 版面上不得出现作者所在单位、姓名（包括英文或
					拼音缩写）或与作者身份有关的任何图标、图形等 个人信息资料。
				</p>
			</div>
		</div>
			...
			<div class="zyStepPanel" id="zyStep1">
				<div class="zyForm">
					<div class="zyFormRow" id="zySelectPersonType">
						<input type="radio" name="participantType" value="1"
							checked="checked" data-target="#zyPersonalInfo"><label>个人</label>
					...
					<div id="zyPersonalInfo" class="zyPersonInfoPanel">
						<div class="zyFormRow">
							...
							<div class="zyFormControl">
								<input type="text" name="participantName"
									class="zyInput zyActionRequired">
							</div>
						...
						<div class="zyFormRow">
							...
							<div class="zyFormControl">
								<input type="text" name="participantIdNumber"
									class="zyInput zyActionRequired">
							</div>
							<span class="zyRequired">*</span>
						</div>
						...
						<div class="zyFormRow">
							...
							<div class="zyFormControl">
								<textarea name="participantBrief"
									class="zyInput zyTextarea zyActionRequired"></textarea>
							</div>
							<span class="zyRequired">*</span>
						</div>
					</div>
					<div id="zyTeamInfo" class="zyPersonInfoPanel zyHidden">
						...
						<div class="zyFormRow">
							...
							<div class="zyFormControl">
								<textarea name="teamMember"
									class="zyInput zyTextarea zyActionRequired"
									placeholder="中文逗号隔开"></textarea>
							</div>
							<span class="zyRequired">*</span>
						</div>
			...
			<div class="zyStepPanel zyHidden" id="zyStep2">
				<div class="zyForm">
					<div class="zyFormRow" id="zySelectGroup">
						<input type="radio" name="groupId" value="1" checked="checked"
							data-target="#zyProductInfo"><label>产品</label> <input
							type="radio" name="groupId" value="2"
							data-target="#zyConceptInfo" style="margin-left: 60px"><label>概念</label>
					</div>
					...
					<div id="zyProductInfo" class="zyWorkInfoPanel">
						<div class="zyFormRow">
							...
							<div class="zyFormControl zySelect" id="zyCategory">
								<input type="text" class="zyInput"> <input type="hidden"
									name="category" class="zySelectValue zyActionRequired">
						...
						<div class="zyFormRow">
							...
							<div class="zyFormControl zyUploadControl"
								id="uploadThumbContainer1">
								<a class="zyBtn zyBtnGray" id="uploadThumbBtn1"> +&nbsp;上传 </a>
								<img id="thumb1" class="zyActionThumbImage" style="width: 100px"
									src="resources/frontend/images/app/defaultThumbImage.jpg" /> <input
									type="hidden" id="thumbUrl1" name="thumb"
									class="zyActionRequired zyActionThumbImageValue">
							</div>
							<span class="zyRequired">*</span>
						</div>
						...
						<div class="zyFormRow">
							...
							<div class="zyFormControl zyUploadControl"
								id="uploadImageContainer1">
								<a class="zyBtn zyBtnGray" id="uploadImageBtn1"> +&nbsp;上传 </a>
								<img id="image1" class="zyActionOtherImage" style="width: 100px"
									src="resources/frontend/images/app/defaultImage.jpg" /> <input
									type="hidden" id="imageUrl1" name="image"
									class="zyActionRequired zyActionOtherImageValue">
							</div>
							<span class="zyRequired">*</span>
						</div>
						...
						<div class="zyFormRow">
							...
							<div class="zyFormControl zyUploadControl"
								id="uploadImageContainer2">
								<a class="zyBtn zyBtnGray" id="uploadImageBtn2"> +&nbsp;上传 </a>
								<img id="image2" class="zyActionOtherImage" style="width: 100px"
									src="resources/frontend/images/app/defaultImage.jpg" /> <input
									type="hidden" id="imageUrl2" class="zyActionOtherImageValue"
									name="image">
							</div>
						</div>
						...
						<div class="zyFormRow">
							...
							<div class="zyFormControl zyUploadControl"
								id="uploadImageContainer3">
								<a class="zyBtn zyBtnGray" id="uploadImageBtn3"> +&nbsp;上传 </a>
								<img id="image3" class="zyActionOtherImage" style="width: 100px"
									src="resources/frontend/images/app/defaultImage.jpg" /> <input
									type="hidden" id="imageUrl3" class="zyActionOtherImageValue"
									name="image">
							</div>
						</div>
						...
						<div class="zyFormRow">
							...
							<div class="zyFormControl" id="uploadAttachContainer">
								<a class="zyBtn zyBtnGray" id="uploadAttachBtn"> +&nbsp;上传 </a>
								<a id="attach" class="zy20C7BE zyActionAttach"
									style="margin-left: 50px;"></a> <input type="hidden"
									id="attachUrl" class="zyActionAttachValue" name="attachFile">
							</div>
						</div>
					...
					<div id="zyConceptInfo" class="zyWorkInfoPanel zyHidden">
						...
						<div class="zyFormRow">
							<label class="zyFormLabel">缩略图</label>
							<div class="zyFormControl zyUploadControl"
								id="uploadThumbContainer2">
								<a class="zyBtn zyBtnGray" id="uploadThumbBtn2"> +&nbsp;上传 </a>
								<img id="thumb2" class="zyActionThumbImage" style="width: 100px"
									src="resources/frontend/images/app/defaultThumbImage.jpg" /> <input
									type="hidden" id="thumbUrl2" name="thumb"
									class="zyActionRequired zyActionThumbImageValue">
							</div>
							<span class="zyRequired">*</span>
						</div>
						...
						<div class="zyFormRow">
							<label class="zyFormLabel">图片1</label>
							<div class="zyFormControl zyUploadControl"
								id="uploadImageContainer4">
								<a class="zyBtn zyBtnGray" id="uploadImageBtn4"> +&nbsp;上传 </a>
								<img id="image4" class="zyActionOtherImage" style="width: 100px"
									src="resources/frontend/images/app/defaultImage.jpg" /> <input
									type="hidden" id="imageUrl4" name="image"
									class="zyActionRequired zyActionOtherImageValue">
							</div>
							<span class="zyRequired">*</span>
						</div>
						...
						<div class="zyFormRow">
							<label class="zyFormLabel">图片2</label>
							<div class="zyFormControl zyUploadControl"
								id="uploadImageContainer5">
								<a class="zyBtn zyBtnGray" id="uploadImageBtn5"> +&nbsp;上传 </a>
								<img id="image5" class="zyActionOtherImage" style="width: 100px"
									src="resources/frontend/images/app/defaultImage.jpg" /> <input
									type="hidden" id="imageUrl5" name="image"
									class="zyActionOtherImageValue">
							</div>
						</div>
						...
						<div class="zyFormRow">
							<label class="zyFormLabel">图片3</label>
							<div class="zyFormControl zyUploadControl"
								id="uploadImageContainer6">
								<a class="zyBtn zyBtnGray" id="uploadImageBtn6"> +&nbsp;上传 </a>
								<img id="image6" class="zyActionOtherImage" style="width: 100px"
									src="resources/frontend/images/app/defaultImage.jpg" /> <input
									type="hidden" id="imageUrl6" name="image"
									class="zyActionOtherImageValue">
							</div>
						</div>
					</div>
